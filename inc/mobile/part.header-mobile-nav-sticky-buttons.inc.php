...
//used to establish default sticky buttons
$company_form = get_option(SM_SITEOP_PREFIX.'company_form');
$company_phone = get_option(SM_SITEOP_PREFIX.'company_phone');
